...
%s',
  ...
  'blog_tools:action:toggle_featured:error' => 'Er is een onbekende fout opgetreden bij het bewerken van de entity, probeer het nogmaals',
  'blog_tools:action:toggle_featured:success' => 'De entity is succesvol bijgewerkt',
