...
%s",
	...
	'blog_tools:notify:expire:subject' => "Un blogue est expirer",
	'blog_tools:notify:expire:message' =>  "Bonjour,

votre blogue « %s » est expirer et n'est plus visible par la communauté.
...
%s",
	...
	'blog_tools:settings:size:master' => "Très grand (550x550)",
	...
	'blog_tools:settings:advanced_gatekeeper' => "Utiliser le contrôleur d'accès avancé",
	'blog_tools:settings:advanced_gatekeeper:description' => "Ceci aidera les utilisateurs qui ne sont pas connecter à trouver un blogue privé facilement",
