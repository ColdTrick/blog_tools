		...
		if ($entity->icontime) {
			...
			if (empty($plugin_settings)) {
				...
				if (!isset($blog_tools_full_image_size)) {
					...
					if ($setting = elgg_get_plugin_setting("full_size", "blog_tools")) {
				...
				if (!isset($blog_tools_full_image_align)) {
					...
					if ($setting = elgg_get_plugin_setting("full_align", "blog_tools")) {
				...
				if (!isset($blog_tools_listing_image_align)) {
					...
					if ($setting = elgg_get_plugin_setting("listing_align", "blog_tools")) {
