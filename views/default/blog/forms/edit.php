<?php
	...
	// set the required variables
				...
				if($vars["entity"]){
					$image_label = elgg_echo("Upload image (leave empty to keep current image)");
				} else {
					$image_label = elgg_echo("Upload image");
				}
				$image_upload = elgg_view('input/file', array('internalname' => 'icon'));
				if($vars["entity"]){
					$image_upload .= "<br />" . elgg_view("input/checkboxes", array("internalname" => "remove_icon", "options" => array("Remove icon" => "remove")));
				}
